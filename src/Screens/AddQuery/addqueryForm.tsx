...
const AddQuery = () => {
  ...
  const onSubmit = async () => {
    const data = await addQuery({
      ticketNo: ticketNoRef.current.value,
      organizationName: organizationNameRef.current.value,
      customerName: customerNameRef.current.value,
      customerEmailId: customerEmailIdRef.current.value,
      customerMobNo: customerMobNoRef.current.value,
      queryType: queryTypeRef.current.value,
      otherQueryType: otherQueryTypeRef.current.value,
      queryDescription: queryDescriptionRef.current.value,
      queryNature: queryNatureRef.current.value,
      queryAssignerTo: queryAssignedtoRef.current.value,
      teamName: teamNameRef.current.value,
      queryStatus: queryStatusRef.current.value,
      queryStage: queryStageRef.current.value,
      stageChangeDate: stageChangeDateRef.current.value,
      futureRequest: futureRequestRef.current.value,
      queryAgeing: queryAgeingRef.current.value,
      createDateAndTime: createdDateAndTimeRef.current.value,
      createdBy: createdByRef.current.value,
      modifyDateAndTime: modifyDateAndTimeRef.current.value,
      modifyBy: modifyByRef.current.value,
      closureDateAndTime: closureDateAndTimeRef.current.value,
      testingStatus: testingStatusRef.current.value,
      testingDoneBy: testingDoneByRef.current.value,
      testingAgeing: testingAgeingRef.current.value,
      testingCompletionDate: testingCompletionDateRef.current.value,
      priority: priorityRef.current.value,
      notes: noteRef.current.value,
      attachment: attachmentRef.current.value,
      totalAgeing: totalAgeingRef.current.value,
      customerRating: customerRatingRef.current.value,
      customerFeedback: customerFeedbackRef.current.value,
    });
    console.log(data);
  };
